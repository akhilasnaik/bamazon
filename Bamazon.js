...
console.log("Welcome to the Akhila Make-Up Store!")
    ...
    .prompt([
      {
        type: "input",
        name: "choice",
        message: "Which item do you want to buy? [Quit with Q]",
...
function completeSale(product, quantity) {
  connection.query(
    ...
    function(err, res) {
      console.log("\nCongrats!  You just purchsed " + quantity + " " + product.product_name + "!");
      getAllProducts();
    }
  );
}
